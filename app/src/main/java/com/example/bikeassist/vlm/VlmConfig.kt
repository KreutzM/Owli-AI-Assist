...
data class VlmConfig(
    ...
    companion object {
        ...
        const val DEFAULT_SYSTEM_PROMPT =
            ...
            "Pflichtfelder: tts_one_liner (kurz), obstacles (Array), landmarks (Array), readable_text (kurz), action_suggestion (kurz). " +
            "Optional: overall_confidence = low|medium|high. " +
            "Niemals sagen 'Weg frei', wenn obstacles nicht leer sind oder overall_confidence nicht high."
        const val DEFAULT_OVERVIEW_PROMPT =
            "Beschreibe die Szene fuer eine Fahrradassistenz. " +
            "Fokussiere Hindernisse, relevante Landmarken und eine vorsichtige Handlungsempfehlung. " +
            "Antworte nur JSON, keine Erklaerungen."
