...
@Composable
fun OpenRouterKeySettingsDialog(
        ...
        Surface(
            ...
            Column(
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    OutlinedButton(onClick = { onSelectMode(OpenRouterKeyMode.EMBEDDED_APP_KEY) }) {
                ...
                TextButton(onClick = onDismiss) {
                    Text(stringResource(R.string.vlm_settings_openrouter_key_close))
                }
            }
        }
    }
