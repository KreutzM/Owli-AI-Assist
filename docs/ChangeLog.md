...
- Translation-Stabilisierung mit Patch-Selection (Low-Res) inkl. Settings (Quality-Min/Search-Radius/Patch-Offset).
- Diagnostics fuer Translation (dx/dy/quality) und Crop-Offsets.
